...
#'   \emph{Elements of Information Theory}, 2nd ed., Ch. 17. Golan, A.,
#'   Judge, G. and Miller, D. (1996). \emph{Maximum Entropy Econometrics:
#'   Robust Estimation with Limited Data}. Wiley. Chapter 3.
#'
